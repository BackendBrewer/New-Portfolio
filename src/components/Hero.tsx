...
export default function Hero() {
  return (
    <section className="mx-auto max-w-3xl px-6 py-24 relative">
      {/* subtle glow behind text — bohot halka, distract nahi karega */}
      ...
      <motion.h1
        ...
        className="text-4xl sm:text-5xl font-bold tracking-tight relative"
      >
      ...
      <motion.p
        ...
        className="mt-4 text-lg text-neutral-400 relative"
      >
