...
const LINKEDIN_URL = "https://linkedin.com/in/m-salman-zubair-140073263";
...
// Top-level components — ab har render pe dobara nahi banenge
        ...
        >
          ...
          >
            ...
            >
              ...
              {toast && (
                <div className="border-t border-neutral-800 px-4 py-2 text-xs text-orange-500 font-mono">
                  ✓ {toast}
                </div>
              )}
            </Command>
